  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between rounded-xl border border-gray-200 bg-white px-3 py-2 text-left text-xs font-medium transition-all hover:border-gray-200 focus:ring-2 focus:ring-blue-500 md:px-4 md:py-3 md:text-sm"
      >
        <span
